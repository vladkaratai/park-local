  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-100 px-4 py-8">
      <div className="max-w-md mx-auto">
        ...
        {/* Blocked Status */}
        <Card className="mb-8 shadow-xl bg-white border-red-200">
          <CardContent className="p-6">
            ...
            <div className="bg-red-50 rounded-lg p-4 space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold text-red-600">Time exceeded</span>
              </div>
              <div className="flex justify-between items-center">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between py-2">
              <div className="flex items-center">
                ...
                <span className="text-gray-700">Paid time:</span>
              </div>
        ...
        {/* Payment Details */}
        <Card className="mb-8 shadow-xl bg-white border-amber-200">
          <CardHeader>
            <CardTitle className="flex items-center text-gray-800">
              Payment Details
            </CardTitle>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Penalty for exceeding:</span>
        ...
        <Button 
          ...
          className="w-full bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 text-white font-semibold py-4 text-lg rounded-xl shadow-lg transform transition hover:scale-105"
