    ...
    <div className="min-h-screen bg-background px-4 py-8">
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="bg-secondary rounded-full p-4 w-20 h-20 mx-auto mb-4 shadow-lg">
            <div className="bg-gradient-to-br from-purple-600 to-pink-600 rounded-full w-full h-full flex items-center justify-center">
        ...
        <Card className="mb-8 shadow-xl bg-secondary/50 backdrop-blur">
        ...
        <Card className="mb-8 shadow-xl bg-secondary/80 backdrop-blur">
          <CardContent className="p-6">
            <div className="text-center mb-6">
              <div className="bg-gradient-to-br from-purple-500 to-blue-500 rounded-full p-4 w-16 h-16 mx-auto mb-4">
